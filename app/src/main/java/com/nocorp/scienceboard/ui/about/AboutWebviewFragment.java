...
public class AboutWebviewFragment extends Fragment {
    ...
    private final String termsHtml = "" +
            ...
            "                  to it, still belong to Francesco Scutellaro.\n" +
            "                </p> <p>\n" +
            "                  Francesco Scutellaro is committed to ensuring that the app is\n" +
            ...
            "                </p> <p>\n" +
            "                  The NewsBoard app stores and processes personal data that\n" +
            ...
            "                  that the NewsBoard app won’t work properly or at all.\n" +
            "                </p> <div><p>\n" +
            ...
            "                  </p> <ul><li><a href=\"https://policies.google.com/terms\" target=\"_blank\" rel=\"noopener noreferrer\">Google Play Services</a></li><li><a href=\"https://developers.google.com/admob/terms\" target=\"_blank\" rel=\"noopener noreferrer\">AdMob</a></li><li><a href=\"https://firebase.google.com/terms/analytics\" target=\"_blank\" rel=\"noopener noreferrer\">Google Analytics for Firebase</a></li><li><a href=\"https://firebase.google.com/terms/crashlytics\" target=\"_blank\" rel=\"noopener noreferrer\">Firebase Crashlytics</a></li><li><a href=\"https://www.facebook.com/legal/terms/plain_text_terms\" target=\"_blank\" rel=\"noopener noreferrer\">Facebook</a></li><!----><!----><!----><!----><li><a href=\"https://www.appodeal.com/home/terms-of-service/\" target=\"_blank\" rel=\"noopener noreferrer\">Appodeal</a></li><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----></ul></div> <p>\n" +
            "                  You should be aware that there are certain things that\n" +
            "                  Francesco Scutellaro will not take responsibility for. Certain\n" +
            "                  functions of the app will require the app to have an active\n" +
            "                  internet connection. The connection can be Wi-Fi, or provided\n" +
            "                  by your mobile network provider, but Francesco Scutellaro\n" +
            ...
            "                </p> <p>\n" +
            "                  Along the same lines, Francesco Scutellaro cannot always take\n" +
            "                  responsibility for the way you use the app i.e. You need to\n" +
            "                  make sure that your device stays charged – if it runs out of\n" +
            "                  battery and you can’t turn it on to avail the Service,\n" +
            "                  Francesco Scutellaro cannot accept responsibility.\n" +
            "                </p> <p>\n" +
            "                  With respect to Francesco Scutellaro’s responsibility for your\n" +
            "                  use of the app, when you’re using the app, it’s important to\n" +
            "                  bear in mind that although we endeavour to ensure that it is\n" +
            "                  updated and correct at all times, we do rely on third parties\n" +
            "                  to provide information to us so that we can make it available\n" +
            "                  to you. Francesco Scutellaro accepts no liability for any\n" +
            ...
            "                  using the app. Francesco Scutellaro does not promise that it\n" +
    ...
    private final String privacyHtml = "" +
            ...
            "                  Francesco Scutellaro built the NewsBoard app as\n" +
            ...
            "                  NewsBoard unless otherwise defined in this Privacy Policy.\n" +
            "                </p> <p><strong>Information Collection and Use</strong></p> <p>\n" +
            "                  For a better experience, while using our Service, I\n" +
            "                  may require you to provide us with certain personally\n" +
            "                  identifiable information, including but not limited to app usage for analytics, crash logs. The information that\n" +
            ...
            "                  this page.\n" +
            "                </p> <p>This policy is effective as of 2021-05-01</p> <p><strong>Contact Us</strong></p> <p>\n" +
            "                  If you have any questions or suggestions about my\n" +
            "                  Privacy Policy, do not hesitate to contact me at help.nocorp@gmail.com.\n" +
            "                </p> " +
            "    </body>\n" +
            "    </html>\n" +
            "      ";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if(infoType.equals("privacy")) {
                webview.loadData(privacyHtml, "text/html", "UTF-8");
            }
            else if(infoType.equals("terms")) {
                webview.loadData(termsHtml, "text/html", "UTF-8");
            }
        }
