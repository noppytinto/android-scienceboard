...
public abstract class BaseTabViewModel extends AndroidViewModel implements ArticlesRepositoryListener {
    ...
    private static List<DocumentSnapshot> oldestArticlesSnaposhots;
    ...
    public void onArticlesFetchCompleted(List<ListItem> articles, List<DocumentSnapshot> oldestArticles) {
        ...
        oldestArticlesSnaposhots = oldestArticles;
...
//                sleepforNseconds(1);
                ...
                articleRepository.getNextArticles(oldestArticlesSnaposhots, numArticlesForEachSource, getApplication());
            };
    ...
    public void onNextArticlesFetchCompleted(List<ListItem> newArticles, List<DocumentSnapshot> oldestArticles) {
        ...
        oldestArticlesSnaposhots = new ArrayList<>(oldestArticles);
