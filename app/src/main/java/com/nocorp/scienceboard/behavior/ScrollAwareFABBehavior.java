package com.nocorp.scienceboard.behavior;
...
public class ScrollAwareFABBehavior extends FloatingActionButton.Behavior {
    ...
    public boolean onStartNestedScroll(@NotNull CoordinatorLayout coordinatorLayout,
                                       @NotNull FloatingActionButton child, @NotNull View directTargetChild, @NotNull View target, int nestedScrollAxes, int type) {
